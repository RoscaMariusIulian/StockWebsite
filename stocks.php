...
<html lang="ro-RO">
    ...
    <nav>
		<ul>
			...
			<!--<li><a onclick='createPage();'>Get Values</a></li>-->
			<li><a onclick='buyNumbers();'>Next Day</a></li>
		</ul>
	</nav>
    <section>	
	...
	<div class="card">
	  ...
	  <div class="container">
		<div class="scris">
		<h4><b>Tesla Inc.</b></h4> 
		<strong><p id="priceTSLA">Buy price: </p></strong>
		<?php include 'own.php';
		echo "<strong>Owned: {$result[0]['QUANTITY']}</strong>";
		?>
		</div>
		<form action="buy.php" method="post" id="tesla">
			<input type="hidden" name="title" value="Tesla Inc.">
			<input type="hidden" name="price" id="pretTesla">
		</form>
		<input type="submit" name="buy" value='Buy' form="tesla" class="button" >
	  </div>
	</div>
	...
	<div class="card">
	  ...
	  <div class="container">
		...
		<strong><p id="priceFB" name='price'>Buy price: </p></strong>
		<?php include 'own.php';
		echo "<strong>Owned: {$result[1]['QUANTITY']}</strong>";
		?>
		</div>
		<form action="buy.php" method="post" id="Facebook">
			<input type="hidden" name="title" value="Facebook Inc.">
			<input type="hidden" name="price" id="pretFacebook">
		</form>  
		<input type="submit" name="buy" value='Buy' form="Facebook" class="button">
	  </div>
	</div>
	...
	<div class="card">
	  ...
	  <div class="container">
		...
		<strong><p id="priceAMZN" name='price'>Buy price: </p></strong>
		<?php include 'own.php';
		echo "<strong>Owned: {$result[2]['QUANTITY']}</strong>";
		?>
		</div>
		<form action="buy.php" method="post" id="Amazon">
			<input type="hidden" name="title" value="Amazon.com Inc.">
			<input type="hidden" name="price" id="pretAmazon">
		</form> 
		<input type="submit" name="buy" value='Buy' form="Amazon" class="button">
	  </div>
	</div>
	...
	<div class="card">
	  ...
	  <div class="container">
		...
		<strong><p id="priceATVI">Buy price: </p></strong>
		<?php include 'own.php';
		echo "<strong>Owned: {$result[3]['QUANTITY']}</strong>";
		?>
		</div>
		<form action="buy.php" method="post" id="blizzard">
			<input type="hidden" name="title" value="Blizzard Inc.">
			<input type="hidden" name="price" id="pretBlizzard">
		</form>
		<input type="submit" name="buy" value='Buy' form="blizzard" class="button" >
	  </div>
	</div>
	...
	<div class="card">
	  ...
	  <div class="container">
		...
		<strong><p id="priceMRVL">Buy price: </p></strong>
		<?php include 'own.php';
		echo "<strong>Owned: {$result[4]['QUANTITY']}</strong>";
		?>
		</div>
		<form action="buy.php" method="post" id="marvell">
			<input type="hidden" name="title" value="Marvell Group Ltd." >
			<input type="hidden" name="price" id="pretMarvell">
		</form>
		<input type="submit" name="buy" value='Buy' form="marvell" class="button" >
	  </div>
	</div>
	...
	<div class="card">
	  ...
	  <div class="container">
		...
		<strong><p id="priceGOOGL">Buy price: </p></strong>
		<?php include 'own.php';
		echo "<strong>Owned: {$result[5]['QUANTITY']}</strong>";
		?>
		</div>
		<form action="buy.php" method="post" id="google">
			<input type="hidden" name="title" value="Alphabet Inc.">
			<input type="hidden" name="price" id="pretGoogle">
		</form>
		<input type="submit" name="buy" value='Buy' form="google" class="button" >
	  </div>
	</div>
